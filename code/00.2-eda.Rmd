...
## Whale Identifier column: none= whales with no comments to tell us who they are, unknown= comment said Sounder but no ID confirmed or reporter was unsure, ID= an identified whale that may or may not be a Sounder.

## Sounder column: unknown= comment said Sounder but no ID confirmed, n= a whale with or without an ID that isn't a Sounder, y= an identified Sounder
